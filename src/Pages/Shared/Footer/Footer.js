            ...
            <footer id="dk-footer" className="dk-footer">
                        ...
                        <div className="col-md-12 col-lg-4 mt-5">
                            <div className="dk-footer-box-info">
                                <a href="index.html" className="footer-logo">
                                    <img src={logo} alt="footer_logo" width="80px" className="img-fluid" />
                                </a>
                                <p className="footer-info-text" style={{ color: '#878787' }}>
                                    Oculus Research is creating the future of personal and shared reality.
                                </p>
                ...
                <div className="copyright">
                    <div className="container">
                        <div className="row">
                            <div className="col-md-6">
                                <span>Copyright © 2021, All Right Reserved Oculus</span>
                            </div>
